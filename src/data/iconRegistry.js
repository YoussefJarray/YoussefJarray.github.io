...
function SnakeIcon({ size }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <circle cx="10" cy="20" r="2" fill="#22c55e"/>
...
function BreakoutIcon({ size }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <rect x="6" y="19" width="8" height="2" rx="1" fill="#f97316"/>
    </svg>
  );
}
...
function FolderIcon({ size }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="#f59e0b" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function FileIcon({ size }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="#3b82f6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function TerminalIcon({ size }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function UserIcon({ size }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="#8b5cf6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function SettingsIcon({ size }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="#6b7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function GlobeIcon({ size }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="#06b6d4" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function TypingIcon({ size }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="#f97316" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function renderIcon(id, pixelSize) {
...
export function getAppIcon(id, size = "md") {
  const px = sizes[size] || 22;
  return renderIcon(id, px);
}
...
export function getDesktopIcon(id) {
  return renderIcon(id, 28);
}
